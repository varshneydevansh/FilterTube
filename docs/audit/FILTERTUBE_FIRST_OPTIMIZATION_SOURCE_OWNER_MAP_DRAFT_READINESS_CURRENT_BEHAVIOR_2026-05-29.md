...
| `docs/audit/FILTERTUBE_METHOD_SEMANTIC_PROOF_GAP_INDEX_CURRENT_BEHAVIOR_2026-05-25.md` | Keeps 69 tracked JS/JSX/MJS files and 5,789 lexical callables outside complete per-callable semantic proof. |
...
| --- | --- | --- | --- | --- |
| `FT-SOURCE-OWNER-DRAFT-CLOSURE-00-map-identity` | `FT-SOURCE-OWNER-MAP-DRAFT-00-map-identity` | `mapIdentity` | `FT-SOURCE-OWNER-MAP-00-map-identity`; method gap count 5,789. | Chain linked; packet manifest and complete semantic callable proof missing. |
