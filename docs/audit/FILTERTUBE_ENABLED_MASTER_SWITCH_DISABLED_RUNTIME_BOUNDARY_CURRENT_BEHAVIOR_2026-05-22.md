...
| `backgroundBooleanPassThrough` | `js/background.js:2942` | 34 | 3,529 | Background compiled settings assign `compiledSettings.enabled = enabledFromV4` with other boolean flags. |
| `backgroundInvalidationKeys` | `js/background.js:4956` | 16 | 461 | Background storage-change cache invalidation does not include `enabled`. |
