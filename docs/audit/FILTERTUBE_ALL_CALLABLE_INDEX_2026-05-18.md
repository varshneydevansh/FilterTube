...
| UI/settings runtime | 10 | 1709 | First-pass UI/settings audit exists, but action-level fixtures remain incomplete. |
...
| `js/tab-view.js` | UI/settings runtime | 941 | UI/settings counted |
...
3. **The hot runtime is not the whole product.**
   ...
   generated shell, vendor, build scripts, and website add another 2,742
...
- documented family totals sum to 5,912,
