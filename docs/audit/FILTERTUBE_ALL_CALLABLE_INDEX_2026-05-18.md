...
| UI/settings runtime | 12 | 1842 | First-pass UI/settings audit exists, but action-level fixtures remain incomplete. |
...
| `js/nanah_managed_live_policy.js` | UI/settings runtime | 37 | UI/settings counted |
...
| `js/tab-view.js` | UI/settings runtime | 986 | UI/settings counted |
...
3. **The hot runtime is not the whole product.**
   ...
   generated shell, vendor, build scripts, and website add another 2,875
...
- documented family totals sum to 6,045,
