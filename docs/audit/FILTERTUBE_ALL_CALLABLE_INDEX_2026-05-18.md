...
| UI/settings runtime | 14 | 2073 | First-pass UI/settings audit exists, but action-level fixtures remain incomplete. |
...
| `js/nanah_managed_live_policy.js` | UI/settings runtime | 86 | UI/settings counted |
...
3. **The hot runtime is not the whole product.**
   ...
   generated shell, vendor, build scripts, and website add another 3,108
...
- documented family totals sum to 6,281,
