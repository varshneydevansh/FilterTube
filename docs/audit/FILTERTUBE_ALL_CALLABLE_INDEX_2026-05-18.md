...
| UI/settings runtime | 14 | 1949 | First-pass UI/settings audit exists, but action-level fixtures remain incomplete. |
...
| `js/nanah_managed_open_sync.js` | UI/settings runtime | 32 | UI/settings counted |
...
| `js/tab-view.js` | UI/settings runtime | 1042 | UI/settings counted |
...
3. **The hot runtime is not the whole product.**
   ...
   generated shell, vendor, build scripts, and website add another 2,982
...
- documented family totals sum to 6,154,
