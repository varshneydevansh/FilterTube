...
| UI/settings runtime | 14 | 2023 | First-pass UI/settings audit exists, but action-level fixtures remain incomplete. |
...
| `js/tab-view.js` | UI/settings runtime | 1078 | UI/settings counted |
...
3. **The hot runtime is not the whole product.**
   ...
   generated shell, vendor, build scripts, and website add another 3,058
...
- documented family totals sum to 6,231,
