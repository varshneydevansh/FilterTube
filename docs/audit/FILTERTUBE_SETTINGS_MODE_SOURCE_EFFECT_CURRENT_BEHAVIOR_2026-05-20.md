...
| `release_settings_main_world_runtime_gate` | `js/content_bridge.js:1049-1054` | MAIN-world runtime injection is disabled for no-work blocklist settings but active for whitelist, content filters, category filters, and JSON rules. | Reduces empty SPA work without losing whitelist or rule-bearing JSON behavior. |
