...
artifact snapshot. It is audit-only: no build command was run for this
snapshot, no ZIP was regenerated, no package file was promoted to release
authority, and no runtime source was changed.
