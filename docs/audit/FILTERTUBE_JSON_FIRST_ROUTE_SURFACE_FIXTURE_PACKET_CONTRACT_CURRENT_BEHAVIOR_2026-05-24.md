...
artifact files, 63 method semantic proof gap files covered, 5,469 method
...
12 fixture packet contract rows covered, 63 method semantic proof gap files
...
tests, 63 method semantic proof gap files covered, 5,469 method semantic proof
