...
| `js/nanah_managed_live_policy.js` | 995 | Managed live-send, local-network delivery, mailbox upload handoff, and provider-delivery re-auth helper. Any further growth should split delivery helpers or add explicit owner/decomposition proof before crossing 1000 lines. |
