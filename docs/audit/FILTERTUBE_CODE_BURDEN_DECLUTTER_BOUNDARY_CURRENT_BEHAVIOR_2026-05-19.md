...
| `js/tab-view.js` | 12690 | Dashboard/settings UI surface. Current growth is owned by the managed Nanah keypair provisioning slice; any further growth needs UI/state owner proof and release smoke. |
