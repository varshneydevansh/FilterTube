...
| `css/tab-view.css` | active dashboard CSS | 2,922 | 70,854 | `355c9c8f69d4714aff9042b7988d5606634ec6bc413224e2bb4511950b8bf282` |
...
| `js/tab-view.js` | hand-owned dashboard runtime | 13,983 | 648,765 | `644aca26efd9d36c62ad8f899ec7902167ebbc226f2a93e9801a0cef1bd37e1a` |
| `js/managed_parent_command_center.js` | hand-owned managed parent command-center runtime | 156 | 8,083 | `b33906478fb6d57631da82262562ac65267238b16d33049290ecf76fbd2a45a9` |

## Active CSS State Counters

The 5 active extension UI CSS files currently total 9,474 counted source lines,
243,743 bytes, 1,363 lexical rule blocks, 115 `!important` declarations, 25
...
| `css/tab-view.css` | 435 | 24 | 14 | 12 | 4 | 2 | 1 | 28 | 26 | 74 | 0 |
