...
method semantic proof gap lexical callables covered: 5946
files with complete per-callable semantic proof: 0
lexical callables requiring semantic proof before behavior changes: 5946
...
```text
tracked JS/JSX/MJS files: 70
repo-wide lexical callables: 5946
files with lexical accounting: 70
files with complete per-callable semantic proof: 0
lexical callables requiring semantic proof before behavior changes: 5946
...
| --- | --- | --- |
| `method_convergence_repo_census` | 70 tracked JS/JSX/MJS files and 5,946 lexical callables are visible to the audit. | Visibility can be mistaken for behavior proof. |
| `method_convergence_zero_complete_files` | 0 files have complete per-callable semantic proof; 5,946 lexical callables still require proof before behavior changes. | A behavior patch can touch an unproved callable path while tests only cover a selected slice. |
...
```text
70 tracked JS/JSX/MJS files
        |
        +--> 5,946 lexical callables
        |       +--> 3,170 hot page/background runtime
        |       +--> 2,776 UI, helper, generated, vendor, build, audit-lane, website
        |
...
```mermaid
flowchart TD
  A["70 tracked JS/JSX/MJS files"] --> B["5,946 lexical callables"]
  B --> C["3,170 hot page/background runtime callables"]
  B --> D["2,776 UI, helper, generated, vendor, build, audit-lane, website callables"]
...
| UI/settings runtime | 11 | 1743 | `semantic proof incomplete` |
...
| `js/nanah_sync_adapter.js` | UI/settings runtime | 109 | `semantic proof incomplete` | Nanah envelope, trust, replay, profile target, signing-key authority, and sync parity proof remain incomplete. |
...
| `js/tab-view.js` | UI/settings runtime | 945 | `semantic proof incomplete` | Dashboard profile/list-mode/Nanah/import/export/release-note action proof remains incomplete. |
...
tracked JS/JSX/MJS files still covered: 70
repo-wide lexical callables still requiring semantic proof: 5946
files with complete per-callable semantic proof: 0
