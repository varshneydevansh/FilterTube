...
repo-wide lexical callables: 5977
...
| --- | --- | --- |
| `method_convergence_repo_census` | 70 tracked JS/JSX/MJS files and 5,977 lexical callables are visible to the audit. | Visibility can be mistaken for behavior proof. |
| `method_convergence_zero_complete_files` | 0 files have complete per-callable semantic proof; 5,977 lexical callables still require proof before behavior changes. | A behavior patch can touch an unproved callable path while tests only cover a selected slice. |
...
70 tracked JS/JSX/MJS files
        |
        +--> 5,977 lexical callables
        |       +--> 3,170 hot page/background runtime
        |       +--> 2,807 UI, helper, generated, vendor, build, audit-lane, website
        |
...
```mermaid
flowchart TD
  A["70 tracked JS/JSX/MJS files"] --> B["5,977 lexical callables"]
  B --> C["3,170 hot page/background runtime callables"]
  B --> D["2,807 UI, helper, generated, vendor, build, audit-lane, website callables"]
...
| UI/settings runtime | 11 | 1774 | `semantic proof incomplete` |
...
| `js/tab-view.js` | UI/settings runtime | 956 | `semantic proof incomplete` | Dashboard profile/list-mode/Nanah/import/export/release-note action proof remains incomplete. |
...
repo-wide lexical callables still requiring semantic proof: 5977
files with complete per-callable semantic proof: 0
