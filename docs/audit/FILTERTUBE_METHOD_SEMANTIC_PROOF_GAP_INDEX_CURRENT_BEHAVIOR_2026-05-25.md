...
repo-wide lexical callables: 6073
...
| --- | --- | --- |
| `method_convergence_repo_census` | 71 tracked JS/JSX/MJS files and 6,073 lexical callables are visible to the audit. | Visibility can be mistaken for behavior proof. |
| `method_convergence_zero_complete_files` | 0 files have complete per-callable semantic proof; 6,073 lexical callables still require proof before behavior changes. | A behavior patch can touch an unproved callable path while tests only cover a selected slice. |
...
71 tracked JS/JSX/MJS files
        |
        +--> 6,073 lexical callables
        |       +--> 3,170 hot page/background runtime
        |       +--> 2,903 UI, helper, generated, vendor, build, audit-lane, website
        |
...
```mermaid
flowchart TD
  A["71 tracked JS/JSX/MJS files"] --> B["6,073 lexical callables"]
  B --> C["3,170 hot page/background runtime callables"]
  B --> D["2,903 UI, helper, generated, vendor, build, audit-lane, website callables"]
...
| UI/settings runtime | 12 | 1870 | `semantic proof incomplete` |
...
| `js/nanah_managed_live_policy.js` | UI/settings runtime | 43 | `semantic proof incomplete` | Managed policy live-send payload, signing, scope, revision, trusted-link writes, and outbound send-history proof remain incomplete. |
...
| `js/tab-view.js` | UI/settings runtime | 1008 | `semantic proof incomplete` | Dashboard profile/list-mode/Nanah/import/export/release-note action proof remains incomplete. |
...
repo-wide lexical callables still requiring semantic proof: 6073
files with complete per-callable semantic proof: 0
