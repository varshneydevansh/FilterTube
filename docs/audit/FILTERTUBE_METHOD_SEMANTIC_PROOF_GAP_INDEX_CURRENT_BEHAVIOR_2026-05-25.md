...
| --- | --- | --- |
| `method_convergence_repo_census` | 69 tracked JS/JSX/MJS files and 5,836 lexical callables are visible to the audit. | Visibility can be mistaken for behavior proof. |
| `method_convergence_zero_complete_files` | 0 files have complete per-callable semantic proof; 5,836 lexical callables still require proof before behavior changes. | A behavior patch can touch an unproved callable path while tests only cover a selected slice. |
...
69 tracked JS/JSX/MJS files
        |
        +--> 5,836 lexical callables
        |       +--> 3,166 hot page/background runtime
        |       +--> 2,670 UI, helper, generated, vendor, build, audit-lane, website
        |
...
```mermaid
flowchart TD
  A["69 tracked JS/JSX/MJS files"] --> B["5,836 lexical callables"]
  B --> C["3,166 hot page/background runtime callables"]
  B --> D["2,670 UI, helper, generated, vendor, build, audit-lane, website callables"]
...
| UI/settings runtime | 10 | 1637 | `semantic proof incomplete` |
...
| `js/nanah_sync_adapter.js` | UI/settings runtime | 57 | `semantic proof incomplete` | Nanah envelope, trust, replay, profile target, and sync parity proof remain incomplete. |
...
| `js/tab-view.js` | UI/settings runtime | 921 | `semantic proof incomplete` | Dashboard profile/list-mode/Nanah/import/export/release-note action proof remains incomplete. |
...
repo-wide lexical callables still requiring semantic proof: 5836
files with complete per-callable semantic proof: 0
