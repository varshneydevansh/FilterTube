...
method semantic proof gap lexical callables covered: 6164
files with complete per-callable semantic proof: 0
lexical callables requiring semantic proof before behavior changes: 6164
...
repo-wide lexical callables: 6164
...
| --- | --- | --- |
| `method_convergence_repo_census` | 73 tracked JS/JSX/MJS files and 6,164 lexical callables are visible to the audit. | Visibility can be mistaken for behavior proof. |
| `method_convergence_zero_complete_files` | 0 files have complete per-callable semantic proof; 6,164 lexical callables still require proof before behavior changes. | A behavior patch can touch an unproved callable path while tests only cover a selected slice. |
...
73 tracked JS/JSX/MJS files
        |
        +--> 6,164 lexical callables
        |       +--> 3,172 hot page/background runtime
        |       +--> 2,991 UI, helper, generated, vendor, build, audit-lane, website
        |
...
```mermaid
flowchart TD
  A["73 tracked JS/JSX/MJS files"] --> B["6,164 lexical callables"]
  B --> C["3,172 hot page/background runtime callables"]
  B --> D["2,991 UI, helper, generated, vendor, build, audit-lane, website callables"]
...
| UI/settings runtime | 14 | 1957 | `semantic proof incomplete` |
...
repo-wide lexical callables still requiring semantic proof: 6164
files with complete per-callable semantic proof: 0
