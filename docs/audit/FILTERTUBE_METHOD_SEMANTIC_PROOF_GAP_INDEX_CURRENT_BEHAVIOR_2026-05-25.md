...
| --- | --- | --- |
| `method_convergence_repo_census` | 69 tracked JS/JSX/MJS files and 5,797 lexical callables are visible to the audit. | Visibility can be mistaken for behavior proof. |
| `method_convergence_zero_complete_files` | 0 files have complete per-callable semantic proof; 5,797 lexical callables still require proof before behavior changes. | A behavior patch can touch an unproved callable path while tests only cover a selected slice. |
...
69 tracked JS/JSX/MJS files
        |
        +--> 5,797 lexical callables
        |       +--> 3,166 hot page/background runtime
        |       +--> 2,631 UI, helper, generated, vendor, build, audit-lane, website
        |
...
```mermaid
flowchart TD
  A["69 tracked JS/JSX/MJS files"] --> B["5,797 lexical callables"]
  B --> C["3,166 hot page/background runtime callables"]
  B --> D["2,631 UI, helper, generated, vendor, build, audit-lane, website callables"]
...
| UI/settings runtime | 10 | 1598 | `semantic proof incomplete` |
...
repo-wide lexical callables still requiring semantic proof: 5797
files with complete per-callable semantic proof: 0
