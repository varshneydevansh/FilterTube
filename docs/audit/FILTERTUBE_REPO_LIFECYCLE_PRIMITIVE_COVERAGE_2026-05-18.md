...
| `extension-ui-background-js` | 12 | 420 | Dashboard/popup/background settings, import/export, Nanah, row actions, profile/PIN, managed policy live-send, and UI state work. |
...
Per-file primitive footprint rows: 70
