...
| `extension-ui-background-js` | 13 | 420 | Dashboard/popup/background settings, import/export, Nanah, row actions, profile/PIN, managed policy live-send/open-sync helpers, and UI state work. |
