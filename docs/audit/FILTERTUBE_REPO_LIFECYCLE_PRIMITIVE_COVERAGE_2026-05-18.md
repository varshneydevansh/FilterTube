...
| `js/tab-view.js` | `extension-ui-background-js` | 147 | 0 | 33 | 3 | 87 | 270 |
...
| --- | ---: | --- |
| `js/tab-view.js` | 270 | Large UI mutation/listener surface for settings, profiles, Nanah, import/export, app cards, and dashboard state. |
