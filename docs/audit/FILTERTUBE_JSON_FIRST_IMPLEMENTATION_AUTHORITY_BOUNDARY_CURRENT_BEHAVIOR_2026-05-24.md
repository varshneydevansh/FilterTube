...
69 tracked JS/JSX/MJS files, 5,812 lexical callables, 0 files with complete
per-callable semantic proof, and 5,812 callables still requiring semantic proof
...
| `docs/audit/FILTERTUBE_METHOD_SEMANTIC_PROOF_GAP_INDEX_CURRENT_BEHAVIOR_2026-05-25.md` | 69 tracked JS/JSX/MJS files, 5,812 lexical callables, 0 files with complete per-callable semantic proof, and 5,812 callables still requiring semantic proof before JSON-first behavior changes. |
