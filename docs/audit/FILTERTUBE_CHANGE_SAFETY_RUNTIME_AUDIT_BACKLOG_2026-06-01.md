...
semantic proof gap counts from 5,673 to 5,789 lexical callables. The broad suite
...
failure snapshot: the direct method semantic proof lane passes with 5,789
