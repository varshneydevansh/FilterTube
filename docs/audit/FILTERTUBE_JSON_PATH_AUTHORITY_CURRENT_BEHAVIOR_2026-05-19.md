...
| `json_path_convergence_method_dependency` | 69 tracked JS/JSX/MJS files and 5,789 lexical callables still have 0 complete per-callable semantic proof files. | A JSON path fix can alter unproved parser, mutation, cache, hide, restore, fetch, or teardown behavior. |
