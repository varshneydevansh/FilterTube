...
| `js/tab-view.js` | 12465 | 566832 | `ceadd9ffe3de825966cd277d906e101bda39baaeb2d1b743772edfd78cad4a6a` |
...
| `diagnostic_flow_import_export_backup` | `js/io_manager.js:1670-1987`, `js/tab-view.js:9166-9416` | Import/export, encrypted backup, auto-backup, download fallback, and backup-rotation diagnostics are direct console paths in user-data workflows. | Payload privacy class, encrypted/unencrypted backup redaction, trusted Nanah state policy, and machine-readable import/export report. |
