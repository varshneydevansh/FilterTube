...
| `docs/audit/FILTERTUBE_METHOD_SEMANTIC_PROOF_GAP_INDEX_CURRENT_BEHAVIOR_2026-05-25.md` | 69 tracked JS/JSX/MJS files and 5,789 lexical callables remain at 0 files with complete per-callable semantic proof. |
...
lexical callables linked by sample closure: 5812
