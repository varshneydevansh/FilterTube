...
| Total | 30 | 133 | Public release and website truth boundary |
...
| `scripts/run-test-lane.mjs` | 14 | `classifyPaths`, `changedPathsFromGit`, `laneNames`, `validateLaneFiles`, `runNode`, `runLane`, `runAuditDrift`, `printClassification`, `printList`, `main` |
...
- 133 lexical build/website callables.
