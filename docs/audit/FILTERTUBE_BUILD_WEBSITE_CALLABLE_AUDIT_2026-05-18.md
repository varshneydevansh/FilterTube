...
| --- | ---: | ---: | --- |
| Build and sync scripts | 6 | 61 | Extension ZIPs, generated UI shell, vendor Nanah/QR bundles, native app runtime sync, GitHub release body/assets, focused test-lane runner, lane-owned audit proof drift guard |
...
| Total | 30 | 134 | Public release and website truth boundary |
...
| `scripts/run-test-lane.mjs` | 15 | `classifyPaths`, `auditProofRequirement`, `changedPathsFromGit`, `laneNames`, `validateLaneFiles`, `runNode`, `runLane`, `runAuditDrift`, `printClassification`, `printList`, `main` |
...
- 134 lexical build/website callables.
