...
JS/JSX/MJS files, 5,789 lexical callables, 0 files with complete per-callable
semantic proof, and 5,789 callables requiring semantic proof before behavior
changes.
...
| `docs/audit/FILTERTUBE_METHOD_SEMANTIC_PROOF_GAP_INDEX_CURRENT_BEHAVIOR_2026-05-25.md` | 69 tracked JS/JSX/MJS files, 5,789 lexical callables, 0 files with complete per-callable semantic proof, and 5,789 callables still requiring semantic proof before optimization behavior changes. |
...
69 method semantic proof gap files covered, 5,789 lexical callables still
...
files covered, 5,789 lexical callables still requiring semantic proof, 0 files
