...
skip method proof: the current method gap index still has 63 tracked
JS/JSX/MJS files, 5,469 lexical callables, 0 files with complete per-callable
semantic proof, and 5,469 callables requiring semantic proof before behavior
changes.
...
| `docs/audit/FILTERTUBE_METHOD_SEMANTIC_PROOF_GAP_INDEX_CURRENT_BEHAVIOR_2026-05-25.md` | 63 tracked JS/JSX/MJS files, 5,469 lexical callables, 0 files with complete per-callable semantic proof, and 5,469 callables still requiring semantic proof before optimization behavior changes. |
...
source-owner approval rows covered, 63 method semantic proof gap files covered,
5,469 lexical callables still requiring semantic proof, 0 files with complete
...
12 no-work preservation rows covered, 63 method semantic proof gap files covered,
5,469 lexical callables still requiring semantic proof, 0 files with complete
per-callable semantic proof, 0 runtime source-owner approvals, 0 runtime metric
collector approvals, 0 runtime collector insertion points approved, 0 runtime
...
63 method semantic proof gap files covered, 5,469 lexical callables still
...
source-locus diagnostic privacy rows covered, 63 method semantic proof gap
files covered, 5,469 lexical callables still requiring semantic proof, 0 files
