...
| `tests/runtime/audit-doc-layout-current-behavior.test.mjs` | Pins audit artifact placement: `docs/audit/FILTERTUBE_AUDIT_DOC_LAYOUT_CURRENT_BEHAVIOR_2026-05-24.md` records 0 root-level `FILTERTUBE_*.md` files under plain `docs/`, 550 `docs/audit/FILTERTUBE_*.md` files, root-level audit placement as NO-GO, new audit artifacts under `docs/audit` as GO, and runtime tests under `tests/runtime` as GO. |
