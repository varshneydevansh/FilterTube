...
| Secondary `addFilteredChannel` listener | No trusted UI sender guard; does not forward `message.listType`, so helper defaults to blocklist. | `js/background.js:5209-5246`; `js/content_bridge.js:12805-12822`; `js/content/block_channel.js:1198-1208` | Native/fallback menu path cannot currently express whitelist add even though the helper can. |
