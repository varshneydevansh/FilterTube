...
verification rows covered, 63 method semantic proof gap files covered, 5,469
...
proofs approved, 63 method semantic proof gap files covered, 5,469 lexical
...
covered, 12 fixture provenance approval rows covered, 63 method semantic proof
gap files covered, 5,469 lexical callables still requiring semantic proof, 0
...
approval rows covered, 63 method semantic proof gap files covered, 5,469
lexical callables still requiring semantic proof, 0 files with complete
...
rows covered, 63 method semantic proof gap files covered, 5,469 lexical
callables still requiring semantic proof, 0 files with complete per-callable
