...
verification rows covered, 63 method semantic proof gap files covered, 5,473
...
proofs approved, 63 method semantic proof gap files covered, 5,473 lexical
...
gap files covered, 5,473 lexical callables still requiring semantic proof, 0
...
approval rows covered, 63 method semantic proof gap files covered, 5,473
lexical callables still requiring semantic proof, 0 files with complete
