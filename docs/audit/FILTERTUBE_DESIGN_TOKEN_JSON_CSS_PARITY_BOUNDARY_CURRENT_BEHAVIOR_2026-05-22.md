...
| Active token references | Across 11 selected active UI files there are 726 `var(--ft-...)` references and 82 unique referenced variables. `css/components.css` contributes 176 references, `css/popup.css` 199, `css/tab-view.css` 347, and `html/tab-view.html` 4. |
