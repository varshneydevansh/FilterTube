...
| `js/content_bridge.js:2743` | `narrow-local-owner` | Local current-video-id extraction only. A video id is a join key, not channel identity. |
...
| `docs/audit/FILTERTUBE_ACTIVE_GOAL_COMPLETION_AUDIT_2026-05-21.md:3152`, `docs/audit/FILTERTUBE_ACTIVE_GOAL_COMPLETION_AUDIT_2026-05-21.md:3171`, `tests/runtime/active-goal-completion-audit-current-behavior.test.mjs:12129`, `tests/runtime/active-goal-completion-audit-current-behavior.test.mjs:12131` | `audit-boundary` | Active-goal completion ledger wording. These lines document source-boundary/source-of-truth proof status and the refreshed completion guard only; they are not runtime authority or goal-completion proof. |
