...
js/background.js:3502:runtime.onMessage.addListener:primaryBackgroundActionReceiver
js/background.js:5572:runtime.onMessage.addListener:secondaryBackgroundTypeReceiver
...
js/tab-view.js:3055:runtime.sendMessage:dashboardRuntimeRequest
js/tab-view.js:3295:tabs.sendMessage:dashboardTabRuntimeRequest
js/tab-view.js:11806:runtime.onMessage.addListener:dashboardRuntimeMessageReceiver
```
...
- Content/dashboard code has two more runtime receivers:
  `js/content/bridge_settings.js:200` and `js/tab-view.js:11806`.
