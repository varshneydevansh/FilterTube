...
js/tab-view.js:3066:runtime.sendMessage:dashboardRuntimeRequest
js/tab-view.js:3347:tabs.sendMessage:dashboardTabRuntimeRequest
js/tab-view.js:12471:runtime.onMessage.addListener:dashboardRuntimeMessageReceiver
```
...
- Content/dashboard code has two more runtime receivers:
  `js/content/bridge_settings.js:200` and `js/tab-view.js:12471`.
