...
js/tab-view.js:3102:runtime.sendMessage:dashboardRuntimeRequest
js/tab-view.js:3496:tabs.sendMessage:dashboardTabRuntimeRequest
js/tab-view.js:14057:runtime.onMessage.addListener:dashboardRuntimeMessageReceiver
```
...
- Content/dashboard code has two more runtime receivers:
  `js/content/bridge_settings.js:200` and `js/tab-view.js:14056`.
