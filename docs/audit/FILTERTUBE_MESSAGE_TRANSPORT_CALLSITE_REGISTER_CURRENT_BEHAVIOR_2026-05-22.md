...
js/tab-view.js:3058:runtime.sendMessage:dashboardRuntimeRequest
js/tab-view.js:3339:tabs.sendMessage:dashboardTabRuntimeRequest
js/tab-view.js:11875:runtime.onMessage.addListener:dashboardRuntimeMessageReceiver
```
...
- Content/dashboard code has two more runtime receivers:
  `js/content/bridge_settings.js:200` and `js/tab-view.js:11875`.
