...
| `js/tab-view.js` | 13007 | 597790 | `eec0600c1da1a117f9237217f73079d238594574e481beb880b887889afbb0ee` |
...
js/tab-view.js:3064:runtime.sendMessage:dashboardRuntimeRequest
js/tab-view.js:3345:tabs.sendMessage:dashboardTabRuntimeRequest
js/tab-view.js:12362:runtime.onMessage.addListener:dashboardRuntimeMessageReceiver
```
...
- Content/dashboard code has two more runtime receivers:
  `js/content/bridge_settings.js:200` and `js/tab-view.js:12362`.
