...
function assertStorageCacheConvergenceBoundary(doc) {
  ...
  for (const sourcePin of [
    'js/background.js:1774',
    'js/background.js:4487',
    'js/content/bridge_settings.js:557',
    'js/content/bridge_settings.js:589',
    'js/content/bridge_settings.js:599',
    'js/state_manager.js:2356',
    'js/state_manager.js:243-244',
    'js/settings_shared.js:52',
    'js/settings_shared.js:564',
    'js/background.js:1648',
    'js/background.js:1673',
    'js/background.js:4429',
    'js/background.js:4446',
    'js/background.js:3292',
    'js/background.js:3545',
