...
test('no-work preservation contract rows counts and field names stay pinned', () => {
  ...
  assert.match(doc, /method semantic proof gap files linked by no-work closure: 63/);
  assert.match(doc, /lexical callables linked by no-work closure: 5469/);
...
test('no-work preservation contract is backed by current fixture owner sample artifact and collector gates', () => {
  ...
  assert.match(fixtureProvenanceContract, /method semantic proof gap files covered: 63/);
...
test('no-work preservation contract is linked from audit ledgers and upstream gates', () => {
  ...
  assert.match(runtimeResults, /First optimization no-work preservation contract addendum:[\s\S]*63 method semantic proof gap files covered/);
  assert.match(activeGoal, /First optimization no-work preservation contract addendum:[\s\S]*63 method semantic proof gap files covered/);
  assert.match(objectiveLedger, /First optimization no-work preservation contract addendum:[\s\S]*63 method semantic proof gap files covered/);
  assert.match(trackedIndex, /First optimization no-work preservation contract addendum:[\s\S]*63 method semantic proof gap files covered/);
