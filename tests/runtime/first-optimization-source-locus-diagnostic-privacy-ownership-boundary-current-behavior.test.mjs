...
const anchorChecks = [
  ...
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 57, needle: 'diagnostic logging policy matrix source files: 21' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 58, needle: 'active console callsites: 419' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 59, needle: 'console.log callsites: 203' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 60, needle: 'console.warn callsites: 124' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 61, needle: 'console.error callsites: 68' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 62, needle: 'console.debug callsites: 24' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 63, needle: 'console.info callsites: 0' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 117, needle: '`page-runtime-core` | 196' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 118, needle: '`background-storage-state` | 131' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 128, needle: 'Page runtime extraction' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 129, needle: 'Background identity repair' },
  { file: 'docs/audit/FILTERTUBE_RUNTIME_DIAGNOSTIC_LOGGING_POLICY_MATRIX_CURRENT_BEHAVIOR_2026-05-24.md', line: 130, needle: 'JSON filter engine' },
  ...
  { file: 'js/filter_logic.js', line: 1575, needle: 'console.log(`FilterTube (Filter):`, message, ...args);' },
