...
function assertSourceOwnerMapDraftReadinessClosure(source) {
  ...
  assert.match(draft, /method semantic proof gap lexical callables covered: 5789/);
...
function assertMetricSampleDraftClosure(source) {
  ...
  assert.match(sample, /method semantic proof gap lexical callables covered: 5789/);
  assert.match(sample, /files with complete per-callable semantic proof: 0/);
  assert.match(sample, /lexical callables requiring semantic proof before behavior changes: 5789/);
  ...
  assert.match(sample, /lexical callables linked by sample closure: 5789/);
...
function assertFixtureProvenanceDraftClosure(source) {
  ...
  assert.match(fixture, /method semantic proof gap lexical callables covered: 5789/);
  assert.match(fixture, /files with complete per-callable semantic proof: 0/);
  assert.match(fixture, /lexical callables requiring semantic proof before behavior changes: 5789/);
  ...
  assert.match(fixture, /lexical callables linked by fixture closure: 5789/);
...
function assertNoWorkPreservationDraftClosure(source) {
  ...
  assert.match(noWork, /method semantic proof gap lexical callables covered: 5789/);
  assert.match(noWork, /files with complete per-callable semantic proof: 0/);
  assert.match(noWork, /lexical callables requiring semantic proof before behavior changes: 5789/);
  ...
  assert.match(noWork, /lexical callables linked by no-work closure: 5789/);
...
function assertSideEffectBudgetDraftClosure(source) {
  ...
  assert.match(sideEffect, /method semantic proof gap lexical callables covered: 5789/);
  assert.match(sideEffect, /files with complete per-callable semantic proof: 0/);
  assert.match(sideEffect, /lexical callables requiring semantic proof before behavior changes: 5789/);
  ...
  assert.match(sideEffect, /lexical callables linked by side-effect closure: 5789/);
...
function assertDiagnosticPrivacyDraftClosure(source) {
  ...
  assert.match(diagnostic, /method semantic proof gap lexical callables covered: 5789/);
  assert.match(diagnostic, /files with complete per-callable semantic proof: 0/);
  assert.match(diagnostic, /lexical callables requiring semantic proof before behavior changes: 5789/);
  ...
  assert.match(diagnostic, /lexical callables linked by diagnostic closure: 5789/);
...
function assertParityRolloutDraftClosure(source) {
  ...
  assert.match(parity, /method semantic proof gap lexical callables covered: 5789/);
  assert.match(parity, /files with complete per-callable semantic proof: 0/);
  assert.match(parity, /lexical callables requiring semantic proof before behavior changes: 5789/);
  ...
  assert.match(parity, /lexical callables linked by parity closure: 5789/);
...
function assertVerificationOutputDraftClosure(source) {
  ...
  assert.match(verification, /method semantic proof gap lexical callables covered: 5789/);
  assert.match(verification, /files with complete per-callable semantic proof: 0/);
  assert.match(verification, /lexical callables requiring semantic proof before behavior changes: 5789/);
  ...
  assert.match(verification, /lexical callables linked by verification closure: 5789/);
