...
const anchorChecks = [
  ...
  { file: 'js/filter_logic.js', line: 71, needle: 'window.postMessage({' },
  { file: 'js/filter_logic.js', line: 132, needle: 'window.postMessage({' },
  { file: 'js/filter_logic.js', line: 1502, needle: 'window.postMessage({' },
  { file: 'js/filter_logic.js', line: 1581, needle: "console.log('FilterTube Whitelist (JSON):'" },
  { file: 'js/filter_logic.js', line: 2168, needle: 'scheduleVideoMetaFetch(videoId, { needDuration: false, needDates: false, needCategory: true })' },
