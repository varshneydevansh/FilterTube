...
test('metric artifact foundation packet is linked from audit ledgers and upstream gates', () => {
  ...
  assert.match(activeGoal, /First optimization metric artifact foundation packet addendum:[\s\S]*63 method semantic proof gap files covered/);
  assert.match(objectiveLedger, /First optimization metric artifact foundation packet addendum:[\s\S]*63 method semantic proof gap files covered/);
  assert.match(trackedIndex, /First optimization metric artifact foundation packet addendum:[\s\S]*63 method semantic proof gap files covered/);
});
