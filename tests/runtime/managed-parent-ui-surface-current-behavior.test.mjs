...
test('managed parent UI surface docs and runtime binding are linked', () => {
  ...
  assert.match(tabViewHtml, /Preview the file shape/);
  assert.match(tabViewHtml, /Pick a format to see what parents can import safely/);
  ...
  assert.match(tabViewHtml, /Spreadsheet/);
  ...
  assert.match(tabViewHtml, /Structured list/);
