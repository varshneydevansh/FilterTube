...
test('managed parent UI surface docs and runtime binding are linked', () => {
  ...
  assert.match(tabViewHtml, /Same-network pickup needs an explicit Home Bridge; Wi-Fi alone never grants control/);
  assert.match(tabViewHtml, /Home\/school bridge/);
  assert.match(tabViewHtml, /Home Bridge off/);
  assert.match(tabViewHtml, /It is not automatic Wi-Fi discovery/);
