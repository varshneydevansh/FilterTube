...
test('managed parent UI surface docs and runtime binding are linked', () => {
  ...
  assert.match(tabViewHtml, /id="ftRulePreviewBlockTube"/);
  assert.match(tabViewHtml, /Choose the kind of list you have/);
  assert.match(tabViewHtml, /Each demo shows the exact shape FilterTube can preview before it adds rules/);
  ...
  assert.match(tabViewHtml, /Excel, Numbers, Sheets/);
