...
test('JSON-first implementation locus register line anchors match current source', () => {
  ...
  const anchors = [
    ...
    ['js/filter_logic.js', 'function getByPath(obj, path, defaultValue = undefined) {', 154, filterLogic, true],
    ['js/filter_logic.js', 'const FILTER_RULES = {', 426, filterLogic, true],
    ['js/filter_logic.js', '_checkCategoryFilters(item, rules, rendererType) {', 2126, filterLogic, true],
    ['js/filter_logic.js', "processData(data, dataName = 'unknown') {", 3434, filterLogic, true],
