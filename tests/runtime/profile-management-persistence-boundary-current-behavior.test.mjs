...
test('selected profile management token counts stay pinned', () => {
  ...
  const selected = [
    ...
    ['tab-view saveProfilesV4 tokens: 39', sources.tabView, 'saveProfilesV4', 39],
    ['tab-view loadProfilesV4 tokens: 70', sources.tabView, 'loadProfilesV4', 70],
    ...
    ['tab-view schemaVersion tokens: 23', sources.tabView, 'schemaVersion', 23],
