...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '27abe12284dd108a6ad61b950002646d87dbcdd83c5020584cfbed8ddab60aa6'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-517\.3k-brightgreen\.svg/);
  assert.match(readme, /javascript-76\.3k%20lines-yellow\.svg/);
