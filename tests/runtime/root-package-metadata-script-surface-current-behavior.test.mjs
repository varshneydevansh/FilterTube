...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, 'a05a8ddf0d8bbe9c892822491f495df0de280641266c23a0ebe568619baafb26'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-525\.4k-brightgreen\.svg/);
  assert.match(readme, /javascript-79\.3k%20lines-yellow\.svg/);
