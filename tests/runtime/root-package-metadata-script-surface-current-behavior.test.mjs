...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '354a6adac4f345c1131c644ca46a4355c081350dc3e93314ff1def15ce4c75c1'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-534\.7k-brightgreen\.svg/);
  assert.match(readme, /javascript-82\.0k%20lines-yellow\.svg/);
