...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '295f51dbeaeb6e7a079500dbf0f08188bdbbaf7bfb8b6ffb7bc88ddfc5f7d860'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-516\.4k-brightgreen\.svg/);
  assert.match(readme, /javascript-75\.7k%20lines-yellow\.svg/);
