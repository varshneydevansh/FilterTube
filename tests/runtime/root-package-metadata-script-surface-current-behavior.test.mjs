...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '208d5c2d592f420cf60e75127766355fa4b2ac4e276cc57b8b5d35fe26201b79'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-514\.5k-brightgreen\.svg/);
  assert.match(readme, /javascript-74\.9k%20lines-yellow\.svg/);
