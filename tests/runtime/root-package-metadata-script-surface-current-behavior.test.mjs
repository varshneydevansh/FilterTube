...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, 'ee466856f0c25d97a2b261e1d76f0c0d22673e601e8b4072e103e928165a4036'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-521\.9k-brightgreen\.svg/);
  assert.match(readme, /javascript-78\.1k%20lines-yellow\.svg/);
