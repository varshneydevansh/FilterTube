...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '0c195c401d229bcf4161edcc28a1feb3a6f738318b6d77c9f05df01f5321959e'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-516\.0k-brightgreen\.svg/);
  assert.match(readme, /javascript-75\.6k%20lines-yellow\.svg/);
