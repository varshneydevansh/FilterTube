...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, 'a2491db4ec81143537cc7322d75fcf217db864de5bfba7b882e1776bd425c283'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-528\.5k-brightgreen\.svg/);
  assert.match(readme, /javascript-80\.3k%20lines-yellow\.svg/);
