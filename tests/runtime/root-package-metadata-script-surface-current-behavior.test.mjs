...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '8888691a01ee1c34d1eace3d12e91d3551d43ee5f542feeeeaec896a39d42797'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-521\.7k-brightgreen\.svg/);
  assert.match(readme, /javascript-78\.0k%20lines-yellow\.svg/);
