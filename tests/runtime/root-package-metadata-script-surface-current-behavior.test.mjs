...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '89dc0fee728383e94e33c81e2478ac55f2ff27175260deac5a91005c31368207'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-517\.1k-brightgreen\.svg/);
  assert.match(readme, /javascript-76\.2k%20lines-yellow\.svg/);
