...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '89f7a16ccb7014ef16699497bef1808ef4b9a21dcd78bec4e89eedce4faa5eeb'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-515\.4k-brightgreen\.svg/);
  assert.match(readme, /javascript-75\.0k%20lines-yellow\.svg/);
