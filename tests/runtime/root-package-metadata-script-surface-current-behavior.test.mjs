...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '33a12f707e1be7f0dba05a55fae5e2b1d9f829b01ef8d565919fb8310071752d'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-523\.6k-brightgreen\.svg/);
  assert.match(readme, /javascript-78\.5k%20lines-yellow\.svg/);
