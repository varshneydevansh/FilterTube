...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, 'aaf96659043abf79c45be6c2dbe78661e8610df4cbf4df597f2bb4047a9686ca'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-521\.3k-brightgreen\.svg/);
  assert.match(readme, /javascript-77\.9k%20lines-yellow\.svg/);
