...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '727d3f9d608948b47d1e6158f1f4514f9cac556a52a9821db8a5982959dd5de1'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-526\.0k-brightgreen\.svg/);
  assert.match(readme, /javascript-79\.5k%20lines-yellow\.svg/);
