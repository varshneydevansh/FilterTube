...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '803c5c9699e0bd7dc27be62c38e7c0baaec0295c23635a422d4640b46e787e40'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-532\.5k-brightgreen\.svg/);
  assert.match(readme, /javascript-81\.2k%20lines-yellow\.svg/);
