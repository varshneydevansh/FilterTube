...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '173f3984f8e2558e45077ab3346eb5b3a86bb1e2592b2ef1b43155f31c03eb91'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-518\.6k-brightgreen\.svg/);
  assert.match(readme, /javascript-76\.9k%20lines-yellow\.svg/);
