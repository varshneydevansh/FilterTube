...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, 'b6a5b73d2d02d3bf65caac880eb0357fb0ef3be75e1c9fcbed23c9603e1c1f68'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-518\.3k-brightgreen\.svg/);
  assert.match(readme, /javascript-76\.8k%20lines-yellow\.svg/);
