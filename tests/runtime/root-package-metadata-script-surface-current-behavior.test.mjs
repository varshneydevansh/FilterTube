...
const rootMetadataRows = [
  ...
  ['README.md', 401, 22476, '3d7ca25a3f73f16b3f5ce1e8864fbcff013b1a545b75da9db2f1c3ffcfbc29f2'],
...
test('root public docs expose release and JSON-first claims that still need parity proof', () => {
  ...
  assert.match(readme, /total%20lines-517\.0k-brightgreen\.svg/);
  assert.match(readme, /javascript-76\.1k%20lines-yellow\.svg/);
