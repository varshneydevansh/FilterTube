...
const anchorChecks = [
  ...
  { file: 'js/background.js', line: 1126, needle: 'async function waitForPostBlockEnrichmentBeforeBackup' },
  { file: 'js/background.js', line: 1899, needle: 'function ensureChannelMapCache()' },
  { file: 'js/background.js', line: 1919, needle: 'function flushChannelMapUpdates()' },
  { file: 'js/state_manager.js', line: 2356, needle: 'chrome.storage.onChanged.addListener' },
  { file: 'js/io_manager.js', line: 487, needle: 'async function readStorage(keys)' },
