...
const anchorChecks = [
  ...
  { file: 'js/filter_logic.js', line: 844, needle: 'class YouTubeDataFilter' },
  { file: 'js/filter_logic.js', line: 1825, needle: '_shouldBlock(item, rendererType)' },
  { file: 'js/filter_logic.js', line: 3391, needle: "filter(obj, path = 'root')" },
  ...
  { file: 'js/content_bridge.js', line: 11474, needle: "menuItem.addEventListener('click'" },
  ...
  { file: 'js/content_bridge.js', line: 12141, needle: 'async function handleBlockChannelClick' },
  { file: 'js/content/dom_fallback.js', line: 1890, needle: "settings.listMode === 'whitelist'" },
  ...
  { file: 'build.js', line: 80, needle: 'async function main()' },
  { file: 'build.js', line: 145, needle: 'const zipPath = await createZip' },
