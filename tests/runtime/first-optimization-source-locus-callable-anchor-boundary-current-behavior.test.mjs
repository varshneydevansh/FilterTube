...
const anchorChecks = [
  ...
  { file: 'js/background.js', line: 1112, needle: 'async function waitForPostBlockEnrichmentBeforeBackup' },
  { file: 'js/background.js', line: 1869, needle: 'function ensureChannelMapCache()' },
  { file: 'js/background.js', line: 1889, needle: 'function flushChannelMapUpdates()' },
