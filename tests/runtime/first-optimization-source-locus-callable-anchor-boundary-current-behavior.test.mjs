...
const anchorChecks = [
  ...
  { file: 'js/background.js', line: 1050, needle: 'async function waitForPostBlockEnrichmentBeforeBackup' },
  { file: 'js/background.js', line: 1807, needle: 'function ensureChannelMapCache()' },
  { file: 'js/background.js', line: 1827, needle: 'function flushChannelMapUpdates()' },
