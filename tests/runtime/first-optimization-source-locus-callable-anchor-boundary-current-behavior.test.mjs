...
const anchorChecks = [
  ...
  { file: 'js/background.js', line: 996, needle: 'async function waitForPostBlockEnrichmentBeforeBackup' },
  { file: 'js/background.js', line: 1753, needle: 'function ensureChannelMapCache()' },
  { file: 'js/background.js', line: 1773, needle: 'function flushChannelMapUpdates()' },
