...
const anchorChecks = [
  ...
  { file: 'js/content_bridge.js', line: 1186, needle: 'const observer = new MutationObserver' },
  ...
  { file: 'js/content_bridge.js', line: 11526, needle: "menuItem.addEventListener('click'" },
  ...
  { file: 'js/content_bridge.js', line: 6200, needle: 'const whitelistPendingRefreshState = {' },
  { file: 'js/content_bridge.js', line: 6260, needle: 'whitelistPendingRefreshState.pendingHideTimer = setTimeout' },
