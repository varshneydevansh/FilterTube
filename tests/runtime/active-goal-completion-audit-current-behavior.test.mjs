...
test('active goal completion audit records no implementation-ready claim', () => {
  ...
  assert.match(source, /5,697 lexical callables are not semantic method proof/);
  assert.match(source, /69 tracked JS\/JSX\/MJS files/);
  assert.match(source, /0 files with complete\s+per-callable semantic proof/);
  assert.match(source, /5,697 lexical callables still requiring\s+semantic proof before behavior changes/);
...
test('active goal completion audit records latest YTM stale menu and TMP collaborator identity gates without declaring completion', () => {
  ...
  assert.match(source, /69 tracked JS\/JSX\/MJS\s+files, 5,697 lexical callables requiring semantic proof, 0 complete\s+per-callable proof files/);
  ...
  assert.match(source, /69 tracked JS\/JSX\/MJS files, 5,697 lexical callables, 0\s+complete per-callable proof files/);
