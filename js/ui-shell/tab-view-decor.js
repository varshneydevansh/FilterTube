(() => {
  ...
  function TabViewDecor() {
    return /* @__PURE__ */ _("div", { "aria-hidden": "true", className: "ft-tab-view-ambient" }, /* @__PURE__ */ _("div", { className: "ft-tab-view-ambient__media" }, /* @__PURE__ */ _(
      "video",
      {
    ...
    ), /* @__PURE__ */ _("span", { className: "ft-tab-view-ambient__media-scrim" }), /* @__PURE__ */ _("span", { className: "ft-tab-view-ambient__media-tint" })), /* @__PURE__ */ _("span", { className: "ft-tab-view-ambient__glow ft-tab-view-ambient__glow--left" }), /* @__PURE__ */ _("span", { className: "ft-tab-view-ambient__glow ft-tab-view-ambient__glow--right" }), /* @__PURE__ */ _("span", { className: "ft-tab-view-ambient__glow ft-tab-view-ambient__glow--lower" }));
  }
  applyExtensionEnvironment("tab-view");
  var mountNode = document.getElementById("tabViewShellDecor");
  if (mountNode) {
    J(/* @__PURE__ */ _(TabViewDecor, null), mountNode);
  }
})();
