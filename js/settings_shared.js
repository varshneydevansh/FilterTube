...
(function (global) {
    ...
    function sanitizeChannelEntry(entry, overrides = {}) {
        ...
        return {
            ...
            ...(typeof entry.managedListSourceTitle === 'string' && entry.managedListSourceTitle.trim() ? { managedListSourceTitle: entry.managedListSourceTitle.trim() } : {}),
            ...(typeof entry.managedListSourceVersion === 'string' && entry.managedListSourceVersion.trim() ? { managedListSourceVersion: entry.managedListSourceVersion.trim() } : {}),
            ...(typeof entry.managedListSourceUpdatedLabel === 'string' && entry.managedListSourceUpdatedLabel.trim() ? { managedListSourceUpdatedLabel: entry.managedListSourceUpdatedLabel.trim() } : {}),
            ...(typeof entry.managedListSourceHomepage === 'string' && entry.managedListSourceHomepage.trim() ? { managedListSourceHomepage: entry.managedListSourceHomepage.trim() } : {}),
        ...
        return new Promise(resolve => {
            STORAGE_NAMESPACE?.get([...SETTINGS_KEYS, THEME_KEY, AUTO_BACKUP_KEY, FT_PROFILES_V3_KEY, FT_PROFILES_V4_KEY], result => {
                ...
                resolve({
                    ...
                    hidePlayables: effectiveSettings.hidePlayables,
                ...
                try {
                    ...
                    if (isValidProfilesV4(existingV4)) {
                        ...
                        const payload = {
                            ...
                            hidePlayables: compiledSettings.hidePlayables,
